...
const Schema = (() => {
    ...
    const PARAM_META = {
        ...
        // Special
        unit_cap_value:             { label: 'Unit Cap Value',     group: 'Base Stats',       type: 'float', min: 0, max: 20, step: 1, tooltip: 'Unit cap cost for this unit. Primary cap: vehicles/heavy units, Secondary cap: infantry/light creatures. 0 = free (no cap cost).' },
